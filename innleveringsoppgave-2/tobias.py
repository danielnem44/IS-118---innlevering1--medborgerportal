#Dette er min del av innleveringsoppgave 2 i programmering.
#I denne skal jeg lage et program som har to valfunkjsoner, med 3 beslutninger.
#Først lager jeg en definisjon for valgmulihetene og begrenser den slik at hvis brukeren
...
#NEste må jeg lage selve valgene som brukeren skal ta.
